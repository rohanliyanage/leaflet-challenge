...
// Create the map, giving it the outdoorsmap layers to display on load
...
d3.json(earthquakesURL, function(earthquakeData) {
  ...
  // Determine the marker colors by depth
  ...
  L.geoJSON(earthquakeData, {
    ...
    onEachFeature: function(feature, layer) {
      layer.bindPopup("</p><hr><p>Magnitude: " + feature.properties.mag + "</h3><hr><p>Date: "
      + new Date(feature.properties.time) + "<h3>Location: " + feature.properties.place + "</p>");
    }
  }).addTo(earthquakes);
